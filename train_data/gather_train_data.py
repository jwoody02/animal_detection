...
runMode = "train"
#TODO delete Animal --> generalization
#Add any animals you might need to identify  --> check class-descriptions-boxable spreadsheet to confirm images are available
classes = ["Giraffe","Elephant","Human Body","Animal", "Leopard", "Human Face", "Goat", "Camel", "Zebra", "Bird","Cheetah", "Car", "Bus", "Monkey", "Lion", "Hippopotamus", "Sheep"]
